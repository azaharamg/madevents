...
class Landing extends React.Component {
	...
	componentDidMount() {
		getData().then(data => {
			this.setState({
				events: data['@graph'].filter(event => event.address)
			});
		});
	}
				...
				<main>
					...
					<section className='lead text-muted'>
						...
						<p className='text-justify'>
							Es una aplicación web para consultar los eventos en Madrid y poder filtrarlos por distrito o
							categorías, asi encontrarás fácilmente nuevos eventos a los que asistir !!!
						</p>
					</section>
				</main>
			</Container>
